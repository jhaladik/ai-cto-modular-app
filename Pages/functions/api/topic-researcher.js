...
// @WORKER: WorkerProxy
// 🎯 Role: Secure proxy to bitware_topic_researcher worker
...
export async function onRequest(context) {
  ...
  try {
    ...
    const backendUrl = `${env.TOPIC_RESEARCHER_URL}${endpoint}`;
    ...
    console.error('Topic researcher proxy error:', error);
    return new Response(JSON.stringify({ 
      success: false, 
